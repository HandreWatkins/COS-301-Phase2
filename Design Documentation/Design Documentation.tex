		...
		\subsection{User Interface Designs} %MatthewHughes and Ndivhuwo Nthambeleni
			...
			\begin{center}
						...
						\textbf{\begin{figure}[h]
										\centering
										\includegraphics[width=5in, height=2.5in]{Pictures/Screens/Desktop/04assignment.jpg}
						...
						\textbf{\begin{figure}[h]
										\centering
										\includegraphics[width=5in, height=2.5in]{Pictures/Screens/Desktop/04assignmentStudent.jpg}
						...
						\textbf{\begin{figure}[h]
										\centering
										\includegraphics[width=5in, height=2.5in]{Pictures/Screens/Desktop/05practical.jpg}
						...
						\textbf{\begin{figure}[h]
										\centering
										\includegraphics[width=5in, height=2.5in]{Pictures/Screens/Desktop/05practicalMarkers.jpg}
						...
						\textbf{\begin{figure}[h]
										\centering
										\includegraphics[width=2in, height=2in]{Pictures/Screens/Mobile/01logon.jpg}
										\caption{Mobile Interface: Login Screen}
						\end{figure}
						\FloatBarrier}
						\textbf{\begin{figure}[h]
										\centering
										\includegraphics[width=2in, height=2in]{Pictures/Screens/Mobile/02homePage.jpg}
										\caption{Mobile Interface: Home Screen}
						\end{figure}
						\FloatBarrier}
						\textbf{\begin{figure}[h]
										\centering
										\includegraphics[width=2in, height=2in]{Pictures/Screens/Mobile/03subject.jpg}
										\caption{Mobile Interface: Subject Screen}
						\end{figure}
						\FloatBarrier}
						\textbf{\begin{figure}[h]
										\centering
										\includegraphics[width=2in, height=2in]{Pictures/Screens/Mobile/04marking.jpg}
										\caption{Mobile Interface: Marking Menu Screen}
						\end{figure}
						\FloatBarrier}
						\textbf{\begin{figure}[h]
										\centering
										\includegraphics[width=2in, height=2in]{Pictures/Screens/Mobile/05marking.jpg}
