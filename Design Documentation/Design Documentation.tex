...
generate customizable reports at different levels of granularity.
	...
	\section{Application Design}
		...
		\subsection{Database Desgin} %Lutfiyya
					...
					\caption{SimpleSumAggregator}
					\begin{tabular}{|p{1.0in}|p{1.0in}|p{0.4in}|p{0.5in}|p{0.9in}|p{0.9in}|} \hline 
					Field & Type & Null & Key & Default & Extra \\ \hline 
					...
					\caption{WeightedSumAggregator}
					\begin{tabular}{|p{1.0in}|p{0.9in}|p{0.4in}|p{0.6in}|p{0.9in}|p{0.9in}|} \hline 
					Field & Type & Null & Key & Default & Extra \\ \hline 
